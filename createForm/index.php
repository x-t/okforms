...
if ($c->can === false) {
    ...
    if ($c->why == "ban") {
        ...
        $x->type = "timeout";
        $x->desc = "You have to wait <span id=\"timeoutTime\">{$c->timeout}</span> seconds before making a new form.";
        genErrPage($x);
    }
}
?>
<ul>
    ...
    <li id="choiceLinear"><a href="javascript:add_question('l')"><span class="fas fa-ellipsis-h"></span> Linear scale</a></li>
    <li><a class="ex"></a></li>
